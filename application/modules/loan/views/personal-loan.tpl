...
<section class="compare_hero_unit">
    <div class="sec_grp">            
        <div class="row-fluid" id="coming_soon_newsletter">
            ...
            <div class="span12">
                <div id="coming_soon_info"><img src="{$baseUrl}assets/img/coins-icon.png"> Get free regular money savings tips in Hong Kong</div>
        ...
        <div class="row-fluid">     
            <div class="span12 text-center comingsoon_email">
                ...
                <div class="input-append">
                    ...
                    <a class="btn-nl insurance-btn" title="loan-personal" data-toggle="modal" data-target="#myModal" href="#">Get Free Access Now!</a>
                </div>
            </div>
